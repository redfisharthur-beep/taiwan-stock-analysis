...
export function scoreStock({prices=[],revenues=[],financials=[],institutional=[],official=null}){
 ...
 const pe=official&&num(official.pe)>0?num(official.pe):null;
 const fundamental=[
 ...
 item("財務品質／現金流",10,null,null,null,null,"尚未串接完整負債與現金流資料"),
 item("估值／本益比",10,pe===null?null:pe<=12?10:pe<=20?7:pe<=35?4:1,pe,official?.date,official?.source,"不適用虧損公司、金融業與跨產業直接比較")];
 ...
 const chips=[item("近五交易日法人淨買賣",10,flows===null?null:flows>0?8:flows===0?5:2,flows,dates.at(-1),"FinMind","各類法人合計；尚未按流通股數標準化"),item("股權集中度",5,null,null,null,null,"尚未連結 TDCC 週資料"),item("融資融券",5,null,null,null,null,"尚未連結完整融資融券資料")];
